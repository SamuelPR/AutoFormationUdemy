<div class="container mt-5">
    ...
    <form action="index.php?uc=continents&action=valideForm" method="post" class="col-md-6 offset-md-3 border border-danger p-3 rounded">
        ...
        <div class="row">
            <div class="col"><a href="index.php" class="btn btn-danger btn-block"> Revenir à la liste</a> </div>
